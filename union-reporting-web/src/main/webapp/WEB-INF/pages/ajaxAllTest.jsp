...
<%@ taglib prefix="cjf" uri="http://union-reporting-web/cjf" %>
...
<tags:pagination totalPages="${pTotalPages}" currentPage="${pCurrentPage}" uriPart="${fn:replace(cjf:truncateParams(currURI, 'page'), 'ajax', 'allTests')}" />
